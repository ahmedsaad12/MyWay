package com.endpoint.myway.activities_fragments.activity_about_app;
...
import com.endpoint.myway.databinding.ActivityAboutAppBinding;
                ...
                .enqueue(new Callback<SettingModel>() {
                    ...
                    public void onResponse(Call<SettingModel> call, Response<SettingModel> response) {
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                                ...
                                binding.setContent(response.body().getAbout());
