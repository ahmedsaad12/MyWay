...
import com.endpoint.myway.databinding.SettingRowBinding;
...
public class Setting_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SingleSettingModel> orderlist;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SettingRowBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.setting_row, parent, false);
...
//        msgRightHolder.binding.recliked.setAdapter(comments_adapter);
    ...
    public class EventsHolder extends RecyclerView.ViewHolder {
        public SettingRowBinding binding;

        public EventsHolder(@NonNull SettingRowBinding binding) {
